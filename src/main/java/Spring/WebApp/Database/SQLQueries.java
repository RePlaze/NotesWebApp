...
public class SQLQueries {
    ...
    public static final String INSERT_PROFILE = "INSERT INTO profile (ID) VALUES (?)";
    ...
    public static final String SELECT_PROFILE = "SELECT * FROM profile p JOIN users ON p.ID = users.profile WHERE users.id = ?";
    public static final String UPDATE_USER_PROFILE = "UPDATE profile SET FullName = ?, Email = ?, Gender = ?, DateOfBirth = ?, ID = ? WHERE ID = ?";
